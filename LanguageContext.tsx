...
export const translations = {
  zh: {
    ...
    settings: {
      ...
      // AI Auto-Entry
      aiGroup: 'AI 自动入账',
      autoConfirmThreshold: '自动入账阈值',
      highOnly: '仅高置信度',
      highAndMedium: '高+中置信度',
      manualOnly: '全部手动确认',
      highOnlyDesc: '只有 AI 高度确信的交易才会自动入账',
      highAndMediumDesc: '高和中等置信度的交易都会自动入账',
      manualOnlyDesc: '所有交易都需要手动确认后才入账',
      // Webhook
      webhookConfig: 'Webhook 配置',
      webhookConfigDesc: '用于短信自动记账的 API 密钥',
      userId: '用户 ID',
      webhookKey: 'Webhook Key',
      usageExample: '调用示例',
      regenerate: '重新生成',
      regenerateWarning: '重新生成后，旧的 Key 将立即失效',
      regenerateTitle: '重新生成 Webhook Key',
      regenerateMessage: '确定要重新生成 Webhook Key 吗？生成后，旧的 Key 将立即失效，您需要更新所有使用该 Key 的配置。',
      regenerateConfirm: '确认生成',
      regenerating: '生成中...',
      regenerateFail: '重新生成失败，请稍后重试',
      // Copy/Show actions
      copyUserId: '复制用户ID',
      copyWebhookKey: '复制 Webhook Key',
      showKey: '显示',
      hideKey: '隐藏',
      notSet: '未设置',
      // Change Password
  ...
  en: {
    ...
    settings: {
      ...
      nickname: 'Nickname',
      // AI Auto-Entry
      aiGroup: 'AI Auto-Entry',
      autoConfirmThreshold: 'Auto-Confirm Threshold',
      highOnly: 'High Only',
      highAndMedium: 'High & Medium',
      manualOnly: 'Manual Only',
      highOnlyDesc: 'Only high-confidence transactions are auto-confirmed',
      highAndMediumDesc: 'High and medium confidence transactions are auto-confirmed',
      manualOnlyDesc: 'All transactions require manual confirmation',
      // Webhook
      webhookConfig: 'Webhook Config',
      webhookConfigDesc: 'API key for SMS auto-bookkeeping',
      userId: 'User ID',
      webhookKey: 'Webhook Key',
      usageExample: 'Usage Example',
      regenerate: 'Regenerate',
      regenerateWarning: 'Old key will be invalidated immediately',
      regenerateTitle: 'Regenerate Webhook Key',
      regenerateMessage: 'Are you sure you want to regenerate? The old key will be invalidated immediately. You will need to update all configurations using this key.',
      regenerateConfirm: 'Confirm',
      regenerating: 'Regenerating...',
      regenerateFail: 'Failed to regenerate, please try again',
      // Copy/Show actions
      copyUserId: 'Copy User ID',
      copyWebhookKey: 'Copy Webhook Key',
      showKey: 'Show',
      hideKey: 'Hide',
      notSet: 'Not Set',
      // Change Password
      ...
      passwordChangeFail: 'Failed to change password, please try again',
      saving: 'Saving...',
      saveSuccess: 'Saved',
      // Theme
      themeLight: 'Light',
